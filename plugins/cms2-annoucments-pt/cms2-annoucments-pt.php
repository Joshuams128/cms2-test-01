 ...
 */
 ...
 add_action( 'init', 'cms2_announcements_pt' );

function cms2_announcements_pt() {
   ...
   $args = array(
      ...
      'labels'                => $labels,
      'description'           => __( 'organize and manage company announcements', 'cms2' ),
      'public'               => true,
      'show_ui'               => true,
      'show_in_menu'          => true,
   ...
   register_post_type( 'cms2_announcement_pt', $args );
